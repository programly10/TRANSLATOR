...
class Translator(QWidget):
    ...
    def init_ui(self):
        ...
        bahasa = ["Arabic", "English", "French", "Indonesia", "Japanese", "Russian", "Spanish", "Thai", "Korean"]
        self.combo.addItems(bahasa)
        self.combo.setEditable(True)
        self.combo.lineEdit().setAlignment(Qt.AlignCenter)
        vb.addWidget(self.combo)
        self.target = {"Arabic":"ar", "English":"en", "French":"fr", "Indonesia":"id", "Japanese":"ja", "Russian":"ru", "Spanish":"es", "Thai":"th", "Korean":"ko"}
